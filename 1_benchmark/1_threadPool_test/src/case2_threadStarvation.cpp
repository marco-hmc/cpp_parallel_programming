...
// case2_one_thread_pool: parent and child tasks share the SAME pool.
//   Safe params:  parent_count << worker_count  (free workers exist for children)
//   Deadlock params: parent_count >= worker_count (all workers blocked waiting)
//   Example: with 12 workers, {2, 30} and {4, 30} are safe; {15, 30} deadlocks.
// case2_multi_thread_pool: each parent creates its OWN inner pool.
//   Always safe — no resource sharing between levels.
